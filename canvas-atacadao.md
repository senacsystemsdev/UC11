...
| | 34 centros de distribuição | | App Meu Atacadão | |
| | Marca Atacadão (forte presença nacional) | | E-commerce próprio | |
| | Frota logística e sistemas de TI | | Rappi / iFood | |
| | | | Atacado de entrega (CD) | |

| **Estrutura de Custos** | **Fontes de Receita** |
|---|---|
| Compra de mercadorias dos fornecedores | Venda direta ao consumidor (B2C) |
| Aluguel e manutenção das lojas | Venda para comerciantes e empresas (B2B) |
| Folha de pagamento (>70 mil funcionários) | Postos de gasolina |
| Logística e transporte | Drogarias |
| Tecnologia e sistemas | Taxas de entrega (online) |
